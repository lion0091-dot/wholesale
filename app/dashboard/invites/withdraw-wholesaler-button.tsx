...
export function WithdrawWholesalerButton() {
  ...
  const handleWithdraw = () => {
    if (
      !confirm(
        "정말 사업을 종료(탈퇴)하시겠습니까?\n\n미니샵은 즉시 비활성화되고 신규 발주/초대장 발부가 막힙니다.\n대표자 개인정보는 즉시 삭제되고 다시 로그인할 수 없습니다.\n상호·사업자번호 등 사업자 정보와 기존 발주 내역은 고객의 거래 기록 보존을 위해 유지됩니다.\n\n이 작업은 되돌릴 수 없습니다."
      )
    ) {
      return;
    }
      ...
      {!open ? (
        ...
        >
          <p style={{ fontSize: "12px", color: "#991b1b", lineHeight: 1.7, marginBottom: "12px" }}>
            미니샵이 즉시 비활성화되고 신규 발주·초대장 발부가 막힙니다. 대표자 개인정보는 즉시
            삭제됩니다. 상호·사업자번호와 기존 발주 내역은 고객의 거래 기록 보존을 위해 유지됩니다.
