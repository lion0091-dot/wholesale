...
- **상품관리 화면에 공공 경락가 패널(`app/dashboard/products/market-price-panel.tsx`)을 붙였다.** 공급사가 판매가를 정할 때 오늘 도매시장 시세를 같이 보라는 참고용이다. 목록이 아래로 밀리지 않게 기본은 접어두고 축종(소/돼지) 버튼으로 펼친다.
