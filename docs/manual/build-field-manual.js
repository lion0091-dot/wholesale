...
c.push(
  table([2600, 7038], ["자리", "무엇인가요"], [
    ...
    ["확인이 필요한 박스", "이력을 못 찾았거나 상품이 안 정해진 박스만 모아 둔 자리입니다. 스캔 칸 아래에 항상 보이고, 이 박스 옆에서 \"상품 지정\"·\"번호 바꾸기\"·\"다시 조회\"를 합니다. 없으면 이 자리는 나타나지 않습니다."],
    ["입고 내역(접혀 있음)", "지금까지 찍은 정상 박스 목록입니다. 평소에는 접혀 있고 \"열기\"를 누르면 펼쳐집니다. 지난 박스 취소와 보관 위치는 여기서 합니다."],
  ])
);
c.push(gap());
...
c.push(
  table([3700, 5938], ["상황", "방법"], [
    ...
    ["이력 못 찾음(빨강) — 번호가 틀렸다", "\"확인이 필요한 박스\"에서 그 박스 옆 \"번호 바꾸기\" → 맞는 번호를 넣고 \"확인\". 취소하고 다시 찍을 필요가 없습니다. 실중량은 그대로 옮겨집니다. 조회가 되면 바로 재고에 들어갑니다."],
    ["이력 못 찾음(빨강) — 번호는 맞다", "공급처가 아직 등록하지 않았을 수 있습니다. 시스템이 화면이 열려 있는 동안 몇 분마다 자동으로 다시 조회합니다. 급하면 박스 옆 \"다시 조회\"를 누르거나 상품을 직접 지정하세요."],
    ["상품을 한 번만 지정해 주세요(빨강)", "\"확인이 필요한 박스\"에서 그 박스의 상품을 고릅니다. 고르는 순간 재고에 들어갑니다. 이력의 부위와 고른 상품의 부위가 다르면 \"맞는지 확인해주세요\"라는 경고가 나옵니다. 잘못 골랐으면 사무실에 알려 주세요."],
    ...
    ["보관 위치를 적고 싶음", "입고 내역(열기)의 박스 옆에서 나중에 언제든 적을 수 있습니다(선택 사항). 사진도 붙일 수 있습니다."],
  ])
);
c.push(gap());
...
c.push(
  table([3300, 6338], ["실수", "되돌리는 법"], [
    ["박스를 잘못 찍음", "바로 직후라면 결과 카드의 \"방금 찍은 박스 취소\"를 누릅니다. 지난 박스는 입고 내역을 열어 그 박스의 \"취소\"를 누릅니다. 재고가 원래대로 돌아갑니다. 이미 일부가 출고된 박스는 취소할 수 없습니다."],
