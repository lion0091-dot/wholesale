...
```
09/22 14:30  [입고]  한우 등심  002111111111            A사장   +8.2kg
09/22 15:10  [출고]  한우 등심  002111111111  ORD-001   A사장   -5.0kg
09/22 16:00  [손실]  한우 등심  폐기 — 일부 폐기        A사장   -0.3kg
```
...
**검증 (4종 통과)**: 입고 2건 + 손실 1건 + 출고 1건이 시간 역순으로 이력번호·주문번호·사유·작업자와 함께 조회됨 / 기간 요약(입고 15.70, 출고 -5.00, 손실 -0.30) / 유형 필터(출고만) / 다른 업체 계정은 0건.
