...
c.push(
  table([2600, 7038], ["자리", "무엇인가요"], [
    ["맨 위 파란 카드", "지금 할 일 하나를 큰 버튼으로 알려 줍니다. 위에 주황색 \"현장 업무\" 표시가 붙으면 현장이 할 일입니다. 어디를 먼저 볼지 모르겠으면 이 카드만 따라 하세요. 화면 위쪽 종 모양의 \"확인 필요 박스\"를 눌러도 이 카드로 옵니다."],
    ["박스 등록 1·2·3단계 카드", "스캔 칸 바로 위에 있는 작은 카드로, 박스 하나를 등록하는 순서(바코드 → 실중량 → 입고 등록)만 알려 줍니다. \"지금 할 일\"과 다른 말을 하지 않습니다. 확인이 필요한 박스가 있으면 \"위 카드를 먼저 처리하세요\"라고만 나옵니다."],
...
c.push(
  table([3700, 2100, 3838], ["카드에 뜨는 말", "버튼", "무슨 뜻인가요"], [
    ["확인이 필요한 박스 N개를 먼저 처리하세요", "확인 필요 박스로 가기", "이력을 못 찾았거나 상품이 안 정해진 박스가 있으면 항상 이 카드가 가장 먼저 뜹니다(전표가 있어도 마찬가지). 그 박스 옆에서 \"상품 지정\"(이력 못 찾음이면 \"번호 바꾸기\")을 하면 이 안내가 다음 할 일로 바뀝니다. 새 박스를 먼저 찍고 싶으면 카드의 작은 링크를 누르세요."],
    ["박스의 바코드를 스캔하세요", "스캔 시작", "처리할 전표가 없습니다. 그냥 찍으면 재고에 들어갑니다."],
    ["박스 N개를 더 찍어 주세요", "박스 스캔하기", "전표에는 있는데 아직 안 찍은 박스가 남았습니다. 오는 대로 찍으세요."],
    ["전표무게보다 작은무게인 명세내역 N개", "박스 스캔하기", "전표에 무게로만 적힌 줄 N개가 아직 그 무게에 못 미쳤습니다(박스가 N개 남았다는 뜻이 아닙니다). 몇 박스가 더 올지는 알 수 없으니 오는 대로 찍으세요. 박스 무게 합이 전표 무게에 차면(±2%) 저절로 빠집니다. 끝내 안 오면 \"스캔 종료\"를 누르세요."],
