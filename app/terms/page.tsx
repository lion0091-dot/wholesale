    ...
    <main style={{ maxWidth: "768px", margin: "0 auto", padding: "40px 20px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "24px", fontSize: "14px", lineHeight: "1.8", color: "#334155" }}>
        <section>
          ...
          <p>
            본 약관은 미트 파트너스(이하 &apos;회사&apos;)이 제공하는 비공개 폐쇄형 B2B 육류 모바일 발주 중개 솔루션(이하 &apos;서비스&apos;)의 이용과 관련하여 회사와 이용자(도매업자 및 고객(소매)) 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            1. &apos;도매업자(판매자)&apos;란 본 플랫폼의 승인을 득하고 월 구독료를 납부하여 고객(소매)에게 전용 모바일 미니샵을 제공하고 상품을 등록/판매하는 사업자를 말합니다.<br />
            2. &apos;고객(소매)&apos;란 특정 도매업자로부터 고유 접속 토큰 URL을 제공받아 모바일로 육류 발주서를 작성/제출하는 정육점, 식당, 유통 등 구매 사업자를 말합니다.<br />
            3. &apos;시크릿 딜 룸&apos;이란 도매업자가 일반 시장 가격 붕괴를 방지하기 위해 인증된 고객(소매)에게만 한정 수량 특가 육류를 판매하는 비공개 거래 공간을 의미합니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            1. 회사는 도매업자와 고객(소매) 간의 1:1 직거래 발주 편의를 지원하는 통신판매중개자이며, 거래되는 육류의 당사자가 아닙니다.<br />
            2. 육류의 원산지, 등급, 품질, 실중량 차이, 유통기한, 배송 및 대금 정산에 관한 책임은 거래 당사자인 도매업자와 고객(소매)에게 있습니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            플랫폼의 보안성과 상호 가격 비밀 유지를 위해 단일 계정은 도매업자 권한과 고객(소매) 권한을 동시에 가질 수 없으며, 타 도매업자의 단가 정보를 부정하게 취득하기 위해 허위 가입한 사실이 적발될 경우 즉시 이용이 영구 정지될 수 있습니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            1. 도매업자는 서비스 이용을 위해 회사가 정한 월 구독료를 납부하여야 하며, 구체적인 금액과 플랜은 [요금 안내 페이지 또는 별도 계약서]에 따릅니다.<br />
        ...
        <section>
          ...
          <p>
            1. 도매업자는 언제든지 서비스 이용 해지를 요청할 수 있으며, 해지 신청일이 속한 달의 구독료는 환불되지 않고 다음 달부터 청구가 중단됩니다.<br />
